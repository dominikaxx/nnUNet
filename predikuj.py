...
def main():
    ...
    os.system(
        "nnUNet_predict -i {} -o {} -t 600 -m 3d_fullres -tr diplomovka_nnUNetTrainer --save_npz".format(
            tmp_input_folder, tmp_output_folder_inferencia))
    convert_labels_back_to_BraTS_2018_2019_convention(join(tmp_output_folder, 'pp_output'),
                                                      join(tmp_output_folder, 'pp_output_converted'))
